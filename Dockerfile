...
# Install Zoom dependencies
    apt-get install --no-install-recommends -y \
        ...
        libxcb-xtest0 && \
# Install Zoom
    wget -q -O zoom_amd64.deb https://cdn.zoom.us/prod/6.2.11.5069/zoom_amd64.deb && \
...
RUN apt-get install -y libxcb-xinerama0-dev libxkbcommon-x11-0 libgl1-mesa-glx

RUN apt-get install -y libxcb-xinerama0 libxcb-icccm4 libxcb-image0 libxcb-keysyms1 libxcb-randr0 libxcb-render0 libxcb-render-util0 libxcb-shape0 libxcb-sync1 libxcb-xfixes0
